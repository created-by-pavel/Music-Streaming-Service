...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/song/**").hasAnyAuthority("USER");
        http.authorizeRequests().antMatchers("/security/**").permitAll();
        http.authorizeRequests().antMatchers("/playlist/**").hasAnyAuthority("USER");
        http.authorizeRequests().antMatchers("/artist/**").hasAnyAuthority("USER");
        http.authorizeRequests().antMatchers("/album/**").hasAnyAuthority("USER");
